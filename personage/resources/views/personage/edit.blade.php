	...
	<div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="{{ url('/familie/'. $personage->familie_id .'/bekijken/'. $personage->personage_id .'/edit')}} " method="POST">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <input type="text" class="form-control verhaal-toevoegen" value="{{ $personage->naam }}" name="naam">
                <input type="text" class="form-control verhaal-toevoegen" value="{{ $personage->afbeelding }}" name="afbeelding">
                <input type="number" class="form-control verhaal-toevoegen" value="{{ $personage->leeftijd }}" name="leeftijd">
                ...
                <input type="text" class="form-control verhaal-toevoegen" value="{{ $personage->superkrachten }}" name="superkrachten">
                <textarea class="form-control" id="verhaal-text" name="achtergrondinformatie">{{ $personage->achtergrondinformatie }}</textarea>
                ...
                <textarea class="form-control" id="verhaal-text" name="opmerkingen">{{ $personage->opmerkingen }}</textarea>
